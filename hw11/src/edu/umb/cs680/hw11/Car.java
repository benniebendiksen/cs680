...
public LinkedList<Car> dominationList = new LinkedList<Car>();
	...
	public void setDominationCount( ArrayList<Car> car){
		int priceCompareValue, mileageCompareValue, yearCompareValue;
		...
		if (car.size() > 1) {
			...
			for (int i = 0; i < car.size(); i++) {
				...
				yearCompareValue = YearComparator.compare(this, car.get(i));
				priceCompareValue = PriceComparator.compare(this, car.get(i));	
				mileageCompareValue = MileageComparator.compare(this, car.get(i));	
